...
const validateFields = (fields) => {
  const requiredFields = [
    'userType', 'email', 'tagline', 'password', 'restaurantName',
...
//       console.log("hit Signup..?", req.formData());
      ...
      // const { userType, email, password, username, restaurantDetails, addressDetails } = req.body;
...
//    const { userType, email, password, username, restaurantDetails, addressDetails } = await request.json();

//    console.log("Request received for Signup:", { userType, email, restaurantDetails, addressDetails });
...
//     });
//   } else {
//     // Return an error if userType is invalid
