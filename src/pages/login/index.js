        ...
        >
          <Box sx={{ width: "100%", maxWidth: 400 }}>
            ...
            >
              ...
              >
                <FormControlLabel
                  label="Are you SuperAdmin"
                  control={
                    <Checkbox
                      checked={isSuperAdmin && !isRestaurantAdmin}
                      onChange={(e) => {
              ...
              >
                <FormControlLabel
                  label="Or Are you Restaurant Admin"
                  control={
                    <Checkbox
                      checked={!isSuperAdmin && isRestaurantAdmin}
                      onChange={(e) => {
                        setIsRestaurantAdmin(e.target.checked);
