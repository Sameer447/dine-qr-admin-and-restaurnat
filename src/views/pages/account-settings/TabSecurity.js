...
const recentDeviceData = [
  {
    ...
    browserIcon: (
      <Box
        component="span"
        sx={{ mr: 2.5, display: "flex", "& svg": { color: "info.main" } }}
      >
  ...
  },
  {
    ...
    browserIcon: (
      <Box
        component="span"
        sx={{ mr: 2.5, display: "flex", "& svg": { color: "error.main" } }}
      >
  ...
  },
  {
    ...
    browserIcon: (
      <Box
        component="span"
        sx={{ mr: 2.5, display: "flex", "& svg": { color: "success.main" } }}
      >
  ...
  },
  {
    ...
    browserIcon: (
      <Box
        component="span"
        sx={{ mr: 2.5, display: "flex", "& svg": { color: "secondary.main" } }}
      >
            ...
            {apiKeyList.map((item) => {
              return (
                ...
                >
                  ...
                  <Box sx={{ mb: 4, display: "flex", alignItems: "center" }}>
                    <Typography
                      sx={{ mr: 2.5, color: "text.secondary", fontWeight: 500 }}
                    >
                      {item.key}
                    </Typography>
                    <Box
